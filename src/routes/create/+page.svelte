    ...
    <div class="w-full max-w-2xl mx-auto">
      <div class="space-y-6">
        ...
        <form onsubmit={handleSubmit} class="space-y-6">
          ...
          >
            <h2 class="text-lg font-semibold text-center">Basic Information</h2>

            <div class="space-y-2">
              <label for="title" class="text-sm font-medium block text-center">Recipe Title *</label>
              <input
                id="title"
                type="text"
                bind:value={title}
            ...
            <div class="space-y-2">
              <label for="description" class="text-sm font-medium block text-center">Description *</label>
              <textarea
                id="description"
                ...
                class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 min-h-[80px]"
              ></textarea>
            </div>

            <div class="space-y-2">
              <label for="imageUrl" class="text-sm font-medium block text-center">Image URL (optional)</label>
              <input
                id="imageUrl"
                type="url"
                bind:value={imageUrl}
            ...
            <div class="space-y-2">
              <label for="tags" class="text-sm font-medium block text-center">Tags (comma-separated)</label>
              <input
                id="tags"
                type="text"
                bind:value={tags}
          ...
          <div
            class="rounded-lg border bg-card text-card-foreground shadow-sm p-6 space-y-4"
          >
            <h2 class="text-lg font-semibold text-center">Recipe Details</h2>

            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div class="space-y-2">
                <label for="prepTime" class="text-sm font-medium block text-center">Prep Time (min)</label>
                <input
                  id="prepTime"
                  type="number"
                  bind:value={prepTime}
              ...
              <div class="space-y-2">
                <label for="cookTime" class="text-sm font-medium block text-center">Cook Time (min)</label>
                <input
                  id="cookTime"
                  type="number"
                  bind:value={cookTime}
              ...
              <div class="space-y-2">
                <label for="servings" class="text-sm font-medium block text-center">Servings</label>
                <input
                  id="servings"
                  type="number"
                  bind:value={servings}
              ...
              <div class="space-y-2">
                <label for="difficulty" class="text-sm font-medium block text-center">Difficulty</label>
                <select
                  id="difficulty"
                  bind:value={difficulty}
                  class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 h-10"
                >
                ...
                <div class="flex gap-3">
                  ...
                  <div class="flex-1 flex gap-2">
                    <textarea
                      ...
                      rows="2"
                      class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 min-h-[60px]"
                    ></textarea>
                    {#if steps.length > 1}
                      <button
                        type="button"
