...
<div class="container flex min-h-screen items-center justify-center py-8 px-4">
  <div class="w-full max-w-7xl">
    ...
    <div class="space-y-6 mb-8">
      ...
      <!-- Tag Filters -->
      <div class="space-y-2">
        <label for="tag-filters" class="text-sm font-medium block text-center">Filter by tags:</label>
        <div id="tag-filters" class="flex flex-wrap gap-2 justify-center">
